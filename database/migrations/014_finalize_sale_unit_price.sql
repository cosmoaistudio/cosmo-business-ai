-- ============================================================
-- 014: Suporte a preço unitário customizado no finalize_sale
-- ============================================================
-- Permite enviar unit_price por item (ex.: produtos com opções no PDV).
-- Depende de: public.finalize_sale (migration 009)
-- ============================================================
