-- Corrige overload ambíguo: migration 007 criou assinatura nova
-- sem remover a versão anterior de finalize_sale (006).

drop function if exists public.finalize_sale(jsonb, text, numeric, numeric, text);

-- Garante a versão unificada com suporte a cliente (007).
